...
|---|---|---|---|
| `sisyphus` | `kimi-for-coding/k2p6` | `zhipuai-coding-plan/glm-5.1` -> `openai/gpt-5.5` medium | 编排/通用 |
| `hephaestus` | `openai/gpt-5.5` medium | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 深度实现 |
| `oracle` | `openai/gpt-5.5` high | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 架构、调试、咨询 |
...
| `prometheus` | `kimi-for-coding/k2p6` | `zhipuai-coding-plan/glm-5.1` -> `openai/gpt-5.5` medium | 通用规划/执行 |
| `metis` | `openai/gpt-5.5` high | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 架构判断 |
| `momus` | `openai/gpt-5.5` xhigh | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 严格审查 |
| `atlas` | `kimi-for-coding/k2p6` | `zhipuai-coding-plan/glm-5.1` -> `openai/gpt-5.5` medium | 通用任务 |
...
| `ultrabrain` | `openai/gpt-5.5` xhigh | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 最高复杂度推理 |
| `deep` | `openai/gpt-5.5` high | `kimi-for-coding/k2p6` -> `zhipuai-coding-plan/glm-5.1` | 深度实现 |
...
| `unspecified-low` | `kimi-for-coding/k2p6` | `zhipuai-coding-plan/glm-5.1` -> `openai/gpt-5.5` medium | 默认低复杂度 |
| `unspecified-high` | `kimi-for-coding/k2p6` | `zhipuai-coding-plan/glm-5.1` -> `openai/gpt-5.5` high | 默认高复杂度 |
...
- `openai/gpt-5.5 = 2`：GPT-5.5 负责深度实现、架构和审查，属于高成本/高延迟重模型，按上游”限制昂贵模型”的原则压低并发。
- `openai = 3`：OpenAI provider 包含 GPT-5.5 主链路，provider 层整体比上游示例 `openai = 5` 更保守。
